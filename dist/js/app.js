...
(() => {
  ...
  const F = {
    loopCreate: function () {
      ...
      for (let e = 0; e < a.length; e += 1)
        n.append(S(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = o.length - 1; e >= 0; e -= 1)
    ...
    Ke = (function () {
      ...
      return (
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              r.LGel.trigger(Be, { index: t, delay: s || 0, isFirstSlide: n });
          }, a);
        }),
  ...
  Qe.length &&
    Qe.forEach((e) => {
      Ze(e, { licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E", speed: 500 });
    }),
    document.addEventListener("DOMContentLoaded", function () {
      const e = new Date(2022, 0, 10);
      let t = null;
      function s(e, t) {
        return t[
          e % 100 > 4 && e % 100 < 20
      ...
      function i() {
        const i = e - new Date();
        i <= 0 && clearInterval(t);
        const l = i > 0 ? Math.floor(i / 1e3 / 60 / 60 / 24) : 0,
          d = i > 0 ? Math.floor(i / 1e3 / 60 / 60) % 24 : 0,
          c = i > 0 ? Math.floor(i / 1e3 / 60) % 60 : 0,
          p = i > 0 ? Math.floor(i / 1e3) % 60 : 0;
        (n.textContent = l < 10 ? "0" + l : l),
          (r.textContent = d < 10 ? "0" + d : d),
          (o.textContent = c < 10 ? "0" + c : c),
          (a.textContent = p < 10 ? "0" + p : p),
          (n.dataset.title = s(l, ["день", "дня", "дней"])),
          (r.dataset.title = s(d, ["час", "часа", "часов"])),
          (o.dataset.title = s(c, ["минута", "минуты", "минут"])),
          (a.dataset.title = s(p, ["секунда", "секунды", "секунд"]));
      }
      const n = document.querySelector(".timer__days"),
        r = document.querySelector(".timer__hours"),
        o = document.querySelector(".timer__minutes"),
        a = document.querySelector(".timer__seconds");
      i(), (t = setInterval(i, 1e3));
    }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
